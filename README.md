...
![CSS3](https://img.shields.io/badge/CSS3-Frontend-1572B6?style=for-the-badge&logo=css3)
...
> Мы не гарантируем вашу безопасность в сети, но повышаем шансы на неё.
...
- Нажмите `Удалить` рядом с нужным расширением.
